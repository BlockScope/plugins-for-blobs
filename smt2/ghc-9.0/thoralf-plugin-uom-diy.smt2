...
; GIVENS (GHC style)
; [G] co_aWx {4}:: One ~ fsk0 (CFunEqCan)
; [G] co_aWv {3}:: Base "m" ~ fsk0 (CFunEqCan)
; [G] co_aWB {3}:: Base "s" ~ fsk0 (CFunEqCan)
; [G] co_aWz {3}:: (fsk0 *: fsk1) ~ fsk2 (CFunEqCan)
; [G] co_aWD {3}:: (fsk0 *: fsk1) ~ fsk2 (CFunEqCan)
; [G] co_aWF {2}:: (fsk0 /: fsk1) ~ fsk2 (CFunEqCan)
; [G] co_aWI {1}:: fsk0 ~ mps (CTyEqCan)

; WANTEDS (GHC style)
; [WD] hole{co_aWQ} {2}:: (mps *: fsk0) ~ fsk1 (CNonCanonical)
...
; (declare-const aWu (Array String Int))
; (declare-const aWw (Array String Int))
; (declare-const aWy (Array String Int))
(declare-const
   aUV
   (Array String Int))
(declare-const
