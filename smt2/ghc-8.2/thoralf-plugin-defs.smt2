...
; WANTEDS (GHC style)
; [WD] hole{ab2T} {2}:: One ~ (Base "K" /: Base "K") (CNonCanonical)
...
; WANTEDS (GHC style)
; [WD] hole{ab3o} {2}:: One ~ (Base "A" /: Base "A") (CNonCanonical)
...
; WANTEDS (GHC style)
; [WD] hole{ab3T} {2}:: One ~ (Base "s" /: Base "s") (CNonCanonical)
...
; WANTEDS (GHC style)
; [WD] hole{ab4T} {2}:: One ~ (Base "m" /: Base "m") (CNonCanonical)
