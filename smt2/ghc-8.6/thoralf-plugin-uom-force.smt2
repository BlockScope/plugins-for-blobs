...
; WANTEDS (GHC style)
; [WD] hole{co_acne} {1}:: 'LiftedRep ~ 'LiftedRep (CNonCanonical)
...
; WANTEDS (GHC style)
; [WD] hole{co_acnM} {1}:: 'LiftedRep ~ 'LiftedRep (CNonCanonical)
