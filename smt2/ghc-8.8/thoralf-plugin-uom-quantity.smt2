...
; GIVENS (GHC style)
; [G] co_ab5o {2}:: Base "m" ~ fsk0 (CFunEqCan)
; [G] co_ab5q {2}:: Base "s" ~ fsk0 (CFunEqCan)
; [G] co_ab5s {1}:: (fsk0 /: fsk1) ~ fsk2 (CFunEqCan)
; [G] co_ab5v {1}:: fsk0 ~ mps (CTyEqCan)

; WANTEDS (GHC style)
; [WD] hole{co_ab5E} {2}:: (mps *: fsk0) ~ fsk1 (CNonCanonical)
...
; DECS1 (seen) 
; DECS1 (unseen) 
; (declare-const ab4d (Array String Int))
; (declare-const ab5n (Array String Int))
; (declare-const ab5p (Array String Int))
; (declare-const ab5r (Array String Int))
(declare-const
   ab4d
   (Array String Int))
(declare-const
